...
{
	SceneManager::GetInstance()->touchActionDown(x, y);
	// Mouse down
}
...
{
	// Mouse up
	SceneManager::GetInstance()->touchActionUp(x, y);
}
...
{
	//Circle *c1 = new Circle(400, 200, 1, 1, 100);
	//Circle *c2 = new Circle(400, 200, 1, 1, 50);
	////Rectangle *r1 = new Rectangle(200,200,1,1,100,100);
	//Rectangles *r1 = new Rectangles(400,200,1,1,200,200);

	Plane *p = new Plane;
	SceneManager::CreateInstance();
	SceneManager::GetInstance()->Init();
	SceneManager::GetInstance()->AddObject(p);
	ESContext esContext;
